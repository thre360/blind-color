Public Class frmStage10
    ...
    Private Sub frmStage10_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblScore.Text = frmStage9.score.ToString()
        lblScore.Text = temp.skorGlobalStage1
        Timer1.Start()
        ResetTimer()
    End Sub
    ...
    Private Sub stage10Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
