Public Class frmStage6
    ...
    Private Sub frmStage6_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblScore.Text = frmStage5.score.ToString()
        lblScore.Text = temp.skorGlobalStage1
        Timer1.Start()
        ResetTimer()
    End Sub
    ...
    Public Sub ResetTimer()
        ...
        stage1Timer.Start()
    End Sub
    Private Sub stage6Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
